...
// isYarnWorkspaceMemberDir to disambiguate between yarn and npm
// workspaces — both ecosystems share the "workspaces" field.
...
// so the caller treats the ancestor as not claiming the target.
